            ...
            <div className='rounded-md p-2 w-full md:w-[80vw] lg:w-[40vw] mx-auto'>
              ...
              <div>
                ...
                <form className='flex gap-2 md:gap-4 justify-between' onSubmit={handelSubmit}>
                  <input type="text" placeholder="Type your message..." className='w-full rounded-md border-2 outline-none px-3 py-2' onChange={(e) => setNewMessage(e.target.value)} value={newMessage} />
